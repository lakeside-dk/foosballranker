// From https://github.com/isamuelson/angularjs-googleanalytics/blob/master/analyticsService.js

var _gaq = _gaq || [];

angular.module('analytics', []).run(['$http', function($http) {

        _gaq.push(['_setAccount', 'UA-39369971-1']);
...
/* Dont want to remove the params
